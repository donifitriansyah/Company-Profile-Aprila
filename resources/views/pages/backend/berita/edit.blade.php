                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="ringkasan" rows="4" class="form-control">{{ old('ringkasan', $berita->ringkasan) }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Isi Berita</label>

                                    <textarea id="editor" name="isi" rows="12" class="form-control">{{ old('isi', $berita->isi) }}</textarea>
                                </div>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_description" rows="3" class="form-control">{{ old('meta_description', $berita->meta_description) }}</textarea>
                                </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('admin-berita.index') }}" class="btn btn-secondary w-100 mt-2">
                                    Kembali
                                </a>
