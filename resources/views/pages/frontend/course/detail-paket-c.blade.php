        ...
        <div class="container">
            <div class="col-lg-10 offset-lg-1 text-center">
                <div class="section-top-title wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
                    <h1>Detail Paket C</h1>
                    <ul>
                        <li><a href="{{ route('welcome') }}">Beranda</a></li>
                        <li> / Detail Paket C</li>
                    </ul>
                </div><!-- //.HERO-TEXT -->
            </div><!--- END COL -->
        </div><!--- END CONTAINER -->
    ...
    <section class="our_event section-padding">
        <div class="container">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <div class="single_event_single">
                        ...
                        <div class="single_event_text_single">
                            ...
                            <p>
                                Program Paket C PKBM Aprila Indonesia merupakan program pendidikan kesetaraan
                                setara Sekolah Menengah Atas (SMA) yang ditujukan bagi peserta didik yang ingin melanjutkan
            ...
            <div class="event_info_register">
                <a class="btn_one"
                    href="https://wa.me/628996567234?text=Halo%20PKBM%20Aprila%20Indonesia,%20saya%20ingin%20mendaftar%20program%20Paket%20C."
                    target="_blank">
                    Daftar Sekarang
                </a>
            </div>
